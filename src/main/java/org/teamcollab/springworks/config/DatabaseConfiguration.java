...
@Configuration
@EnableJpaRepositories("org.teamcollab.springworks.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "org.teamcollab.springworks.config.HerokuDatabaseConfiguration")
